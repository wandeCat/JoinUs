...
<div id="body">
    ...
    <div id="container">
        ...
        <input type="text" id="search_input" name = "kd"  tabindex="1" value="<?php echo $kd ?>"  placeholder="请输入职位名称，如：产品经理"  />
            	            ...
            	            <ul class="hot_pos reset">
            	            	...
            	            	?>
				                    		<li class="odd clearfix">
						                		<div class="hot_pos_l">
						                        	<div class="mb10">
						                            	<a href="h/jobs/86989.html" title="<?php echo $v['job_name'] ?>" target="_blank"><?php echo $v['job_name'] ?></a> 
						                            	&nbsp;
						                            	<span class="c9"><?php echo $v['job_city'] ?></span>
						                            </div>
						                        	<span><em class="c7">月薪：</em><?php echo $v['job_wage'] ?>k</span>
							                        <span><em class="c7">经验：</em><?php echo $v['job_experience'] ?></span>
							                        <span><em class="c7">最低学历： </em><?php echo $v['job_education'] ?></span>
							                        <br />
							                        <span><em class="c7">职位：</em><?php echo $v['job_trade'] ?></span>
							                        <span><em class="c7">工作性质：</em><?php echo $v['job_nature'] ?></span>
							                        <br />
							                        <span><em class="c7">职位诱惑：</em><?php echo $v['job_tag'] ?></span>
							                        <span><em class="c7">工作地点：</em><?php echo $v['job_district'] ?></span>
							                        <br />
							                        <span><em class="c7">发布时间：</em><?php echo date('Y-m-d H:i:s',$v['job_addtime']) ?></span>
							                    </div>
									        	<div class="hot_pos_r">
						                        	<div class="apply">
						                        	...
						                        	<div class="mb10">
						                        		<a href="h/c/1712.html" title="详细" target="_blank">详细内容</a>
						                       		</div>
						                        	<span><em class="c7">工作描述： </em><?php echo $v['job_contents'] ?></span>
						                        	<span><em class="c7">联系邮箱：<?php echo $v['job_email'] ?></em></span>
			                	...
			                	?>
											<li class="odd clearfix">
						                		<div class="hot_pos_l">
						                        	<div class="mb10">
						                            	<a href="h/jobs/86989.html" title="<?php echo $v['company_name'] ?>" target="_blank"><?php echo $v['company_name'] ?></a> 
						                            	&nbsp;
						                            	<span class="c9"><?php echo $v['company_address'] ?></span>
						                            </div>
						                        	<span><em class="c7">公司简介：</em><?php echo $v['company_desc'] ?>k</span>
							                        <span><em class="c7">公司电话：</em><?php echo $v['company_phone'] ?></span>
							                        <br />
							                        <span><em class="c7">公司主页：</em><?php echo $v['company_index'] ?></span>
							                        <br />
						                        	<span><em class="c7">公司类型：</em><?php echo $v['company_type'] ?></em></span>
							                    </div>
									        	<div class="hot_pos_r">
						                        	<div class="apply">
						                        		<a href="toudi.html" target="_blank">投个简历</a>
						                        	...
						                        	<span><em class="c7">公司logo：</em><img src="<?php echo $v['company_logo'] ?>"></span>
						                        	<br />
						                        	<span><em class="c7">公司阶段：</em><?php echo $v['company_radio'] ?></em></span>
						                        	<span><em class="c7">公司规模: </em><?php echo $v['company_scale'] ?></em></span>
						                        	<ul class="companyTags reset"></ul>
						                    	</div>
						                	</li>
			                	<?php
