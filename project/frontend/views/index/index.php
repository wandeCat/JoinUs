...
<div id="body">
    	...
    	<div class="wrapper">
    		...
    		<ul class="reset" id="navheader">
    			...
    			<li ><a href="#" target="_blank">论坛</a></li>
    				    			<li ><a href="index.php?r=pre%2Fpre" rel="nofollow">我的简历</a></li>
    ...
    <div id="container">
		...
		<div id="sidebar">
			<div class="mainNavs">
						<?php foreach($trade as $key=>$val){?>
									<div class="menu_box">
						<div class="menu_main">
							<h2><?= $val['trade_name']?> <span></span></h2>
				...
				<a href="h/jobs/list_架构师?labelWords=label">架构师</a>
						...
						<?php foreach($val['son'] as $son_key=>$son_val){?>
					   								    	<dl class="reset">
					        							        		<dt>
						        	...
						        	<dd>
									<?php foreach($son_val['son'] as $grandson_key=>$grandson_val){?>
							        											   	<a href="h/jobs/list_Java?labelWords=label"
										   		
										   		 									            										            											            			
									            											            										            											            										            											            										            											            										            											            										            											            										            											            										            											            										            											            										            											            										            											            										            										   		
										   	><?= $grandson_val['trade_name']?></a>
											<?php }?>
							            							        </dd>
					        	</dl>
													    	<?php }?>
...
<dl class="hotSearch">
	...
	<dd><a href="list.html?gx=实习&city=">实习</a></dd>
            ...
            <div id="hotList">
				...
				<?php foreach ($job_hot as $key => $val){?>
	            		            		            				            		<li class="clearfix">
		            																		            					                	<div class="hot_pos_l">
			                    	<div class="mb10">
			                        	<a href="h/jobs/147822.html" target="_blank"><?= $val['job_name']?></a> 
			                            &nbsp;
			                            <span class="c9">[<?= $val['job_city']?>]</span>
			                            			                        </div>
			                        <span><em class="c7">月薪： </em><?= $val['job_wage']?></span>
			                        <span><em class="c7">经验：</em> <?= $val['job_experience']?></span>
			                        <span><em class="c7">最低学历： </em><?= $val['job_education']?></span>
			                        <br />
			                        <span><em class="c7">职位诱惑：</em><?= $val['job_tag']?></span>
			                        <br />
				                    <span><?= date('Y-m-d',$val['job_addtime']);
									?></span>
			                        <!-- <a  class="wb">分享到微博</a> -->
			                    </div>
			                	<div class="hot_pos_r">
				...
				<?php foreach($job_new as $key=>$val){?>
	            		            		            				            		<li class="clearfix">
		            				            					                	<div class="hot_pos_l">
			                    	<div class="mb10">
			                        ...
			                        <span><em class="c7">月薪： </em><?= $val['job_wage']?></span>
			                        <span><em class="c7">经验：</em></em><?= $val['job_experience']?></span>
			                        <span><em class="c7">最低学历：</em> <?= $val['job_education']?></span>
			                        <br />
			                        <span><em class="c7">职位诱惑：</em><?= $val['job_tag']?></span>
			                        <br />
				                    <span><?= date('H:i',$val['job_addtime'])?></span>
			                        <!-- <a  class="wb">分享到微博</a> -->
			                    </div>
			                	<div class="hot_pos_r">
