        	...
        	<dl class="c_section c_section_mid">
                ...
                <dd>
	                <form action="?r=pre/create" method="post" enctype="multipart/form-data">
	                    ...
	                    <h3>公司全称 </h3>
	                    <input type="text" placeholder="请输入公司全称" value="" name="company_name" id="name" class="valid">
	                    ...
	                    <h3>公司网址</h3>
	                    <input type="text" placeholder="请输入公司网址" value="" name="company_index" id="website">	
	                    
	                    <h3>所在地址</h3>
	                    <input type="text" placeholder="请输入工作城市，如：北京" name="company_address" id="city">	
	                    <h3>公司电话</h3>
	                    <input type="text" placeholder="请输入公司电话" name="company_phone">	
	                    <h3>行业领域</h3>
	                    <div>
		                    <input type="hidden" value="" name="company_type" id="select_industry_hidden">
	                    ...
	                    <h3>公司规模</h3>
	                    <div>
		                    <input type="hidden" value="" name="company_scale" id="select_scale_hidden">
	                    ...
	                    <h3>发展阶段</h3> 
	                    <div>
		                    <input type="hidden" id="s_radio_hidden" name="company_radio" value="">
	                    ...
	                    <h3>一句话介绍</h3> 
	                    <input type="text" placeholder="一句话概括公司亮点，如公司愿景、领导团队等，限50字" maxlength="50" name="company_desc" id="temptation">	
